...
import { ChevronRight, Mail, Phone, MapPin, Send, CheckCircle2, Sprout, HeartHandshake, Building2 } from 'lucide-react';
      ...
      <div className="bg-gradient-to-r from-[#14532d] via-[#15803d] to-[#166534] text-white py-12 px-4 shadow-inner">
        <div className="container mx-auto max-w-7xl">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold mb-2">
            Liên Hệ Đặt Hàng & Nhận Báo Giá Sỉ
          </h1>
          <p className="text-emerald-100 text-sm max-w-2xl">
            Cung cấp rau an toàn chuẩn VietGAP cho hộ gia đình, trường học, bếp ăn tập thể, nhà hàng và siêu thị với chính sách chiết khấu tốt nhất.
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-gray-200">
              <div className="inline-flex items-center gap-2 text-emerald-700 bg-emerald-50 px-3 py-1 rounded-full text-xs font-bold mb-4">
                <Sprout className="w-3.5 h-3.5" /> HTX Nông Nghiệp Tiêu Biểu Đà Nẵng
              </div>

              <h2 className="text-xl font-bold text-gray-900 mb-4 leading-snug">
                HỢP TÁC XÃ DỊCH VỤ SẢN XUẤT & TIÊU THỤ RAU AN TOÀN TÚY LOAN
              </h2>
              ...
              <div className="space-y-4 text-xs md:text-sm text-gray-700">
                <div className="flex items-start">
                  ...
                  <div>
                    <span className="font-bold text-gray-900">Trụ sở & Vùng sản xuất 8 ha:</span>
                    <p className="text-gray-600 mt-0.5">Thôn Túy Loan Tây, xã Hòa Phong, huyện Hòa Vang, TP. Đà Nẵng</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-0.5">Ông Bùi Dũng - Giám đốc Hợp tác xã</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:0905559206" className="text-emerald-700 font-bold hover:underline">
                      0905 559 206
                    </a>
                    <span className="text-gray-400 mx-1.5">|</span>
                    <a href="tel:02363890407" className="text-emerald-700 font-bold hover:underline">
                      0236 3890 407
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:htxtuyloan@gmail.com" className="text-emerald-700 hover:underline">
                      htxtuyloan@gmail.com
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 bg-emerald-50/50 -mx-6 -mb-6 p-6 rounded-b-3xl">
                <h4 className="font-bold text-emerald-900 text-xs uppercase mb-2">Chính Sách Cung Ứng & Giao Hàng:</h4>
                <ul className="text-xs text-gray-600 space-y-1.5 list-disc list-inside">
                  <li>Cung ứng 1.5 tấn rau tươi/ngày cho siêu thị, trường học, bếp ăn công nghiệp.</li>
                  <li>Thu hoạch sáng sớm từ 4h00, sơ chế và giao tận nơi trong 2 - 4h.</li>
                  <li>Cung cấp đầy đủ hóa đơn VAT, hợp đồng và hồ sơ kiểm định ATTP, OCOP 4 sao.</li>
                </ul>
              </div>
            </div>
          </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 text-xs md:text-sm">
                  ...
                  {status === 'error' && (
                    <div className="p-3 bg-red-50 border border-red-200 text-red-700 text-xs rounded-xl">
                      Có lỗi xảy ra khi gửi thông tin. Vui lòng liên hệ trực tiếp qua số Hotline 0905.123.456.
                    </div>
                  )}
